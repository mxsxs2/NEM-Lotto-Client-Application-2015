...
public class MysqlAccess {
    ...
    public MysqlAccess(){
            classes.ConfigReader cr=new classes.ConfigReader();
                                 cr.readDatabaseDetails();
            this.setDBParams(cr.getDBDetails());
            this.MakeConnection();
    }
    public final void setDBParams(String[] Params){
        this.Param[0]=Params[0];
        this.Param[1]=Params[1];
        this.Param[2]=Params[2];
        this.Param[3]=Params[3];
    }
    private void MakeConnection(){
        try {
            ...
            Connect = DriverManager.getConnection(this.Param[0]+this.Param[1],this.Param[2],this.Param[3]);
